...
export default async function PracticePage() {
  ...
  if (
    ...
    currentPlan?.free_static_problem_sets_lifetime_limit !== null &&
    currentPlan?.free_static_problem_sets_lifetime_limit !== undefined &&
    billing.usage.free_static_problem_sets_used_lifetime >=
      currentPlan.free_static_problem_sets_lifetime_limit
  ) {
